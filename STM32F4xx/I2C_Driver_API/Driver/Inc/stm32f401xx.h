...
#define SPI1_PCLK_EN() (RCC->APB2ENR |=(1U<<12))  //CLOCK ENABLE FOR SPI
...
#define SPI1_PCLK_DI() (RCC->APB2ENR &=~(1U<<12))  //CLOCK DISABLE FOR SPI
...
#define I2C1_PCLK_EN() (RCC->APB1ENR |=(1U<<21))   //CLOCK ENABLE FOR I2C
#define I2C2_PCLK_EN() (RCC->APB1ENR |=(1U<<22))
#define I2C3_PCLK_EN() (RCC->APB1ENR |=(1U<<23))

#define I2C1_PCLK_DI() (RCC->APB1ENR &=~(1U<<21))   //CLOCK DISABLE FOR I2C
...
#define cs_disable() DISABLE


//BIT POSITION DEFINATION FOR I2C_CR1
#define I2C_CR1_PE 0
...
//BIT POSITION DEFINATION FOR I2C_CR2
#define I2C_CR2_FREQ 0
#define I2C_CR2_ITERREN 8
#define I2C_CR2_ITEVTEN 9
#define I2C_CR2_ITBUFEN 10

//BIT POSITION DEFINATION FOR I2C_SR1
#define I2C_SR1_SB 0
...
#define I2C_SR1_ASRLO 9
#define I2C_SR1_AF 10
#define I2C_SR1_OVR 11
#define I2C_SR1_TIMEOUT 14

//BIT POSITION DEFINATION FOR I2C_SR2
...
//BIT POSITION DEFINATION FOR I2C_CCR
#define I2C_CCR_CCR 0
#define I2C_CCR_DUTY 14
#define I2C_CCR_FS 15

//BIT POSITION DEFINATION FOR I2C_OAR1
